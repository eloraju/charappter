...
export const ObjectIdValidator = joi
  .custom((id: ObjectId, helpers: CustomHelpers) => {
    if (!(id instanceof ObjectId)) {
      return helpers.error('any.custom.0');
    }
...
export const RelationNumberValidator = joi
  .object()
  .pattern(ObjectIdStringValidator, joi.number().strict(true).default(0));
